...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    icon: 'trailer',
    name: t('Enclosed Trailers', '封闭式拖车', 'Remorques fermées'),
    shortName: t('Enclosed Trailers', '封闭式拖车', 'Remorques fermées'),
    cardSub: t('Cargo, contractor & custom builds', '货运、工程与定制车型', 'Chargement, entrepreneurs et sur mesure'),
    tagline: t(
      'Rugged, road-ready cargo and contractor trailers with options for every trade.',
      '坚固耐用、随时上路的货运与工程拖车，为各行各业提供丰富选项。',
      'Des remorques de chargement robustes et prêtes pour la route, avec des options pour chaque métier.'
    ),
    description: [
      t(
        'NEXUS enclosed trailers are framed in steel, clad in weatherproof skins and finished with automotive-grade components — built to handle Canadian highways season after season.',
        'NEXUS 封闭式拖车采用钢制车架、耐候外皮与汽车级部件——专为加拿大公路的常年使用而打造。',
        'Les remorques fermées NEXUS sont construites en acier, revêtues de peaux imperméables et finies avec des composants de qualité automobile — conçues pour les autoroutes canadiennes, saison après saison.'
      ),
      t(
        'Configure ramp doors, e-track tie-downs, cabinets, lighting and power — or spec a fully custom trades rig with workbenches and onboard generators.',
        '配置坡道门、E 轨固定点、柜体、照明与电源——或完全定制的工程作业车，配备工作台与车载发电机。',
        'Configurez portes rampe, points d’ancrage e-track, armoires, éclairage et énergie — ou spécifiez un atelier roulant entièrement personnalisé avec établis et génératrice embarquée.'
      ),
    ],
    highlights: [
      t('Steel frame with weatherproof exterior skin', '钢制车架与耐候外皮', 'Châssis en acier et peau extérieure imperméable'),
      t('Ramp, barn or custom door configurations', '坡道门、仓栅门或定制门型', 'Configurations de portes rampe, double ou sur mesure'),
      t('E-track and D-ring tie-down systems', 'E 轨与 D 环固定系统', "Systèmes d'ancrage e-track et anneaux en D"),
      t('Interior cabinets, benches & work surfaces', '车内柜体、工作台与操作面', 'Armoires, établis et surfaces de travail intérieures'),
      t('12V / 110V power & lighting packages', '12V/110V 电源与照明方案', 'Forfaits d’énergie et d’éclairage 12 V / 110 V'),
    ],
    packages: [
      {
        id: 'standard',
        features: [
          t('Single-axle or tandem axle options', '单轴或双轴可选', 'Options essieu simple ou tandem'),
          t('Ply-lined walls and floor', '胶合板内衬墙板与地板', 'Plaques de contreplaqué aux murs et au plancher'),
          t('Rear ramp door', '后坡道门', 'Porte rampe arrière'),
          t('LED interior and marker lights', 'LED 内部照明与示宽灯', 'Éclairage intérieur DEL et feux de gabarit'),
          t('Wall-mounted D-rings', '壁挂式 D 环固定点', 'Anneaux d’arrimage muraux'),
          t('Standard paint colours', '标准烤漆颜色', 'Couleurs de peinture standard'),
        ],
      },
      {
        id: 'comfort',
        features: [
          t('Upgraded axles, brakes and tires', '升级车轴、刹车与轮胎', 'Essieux, freins et pneus améliorés'),
          t('Screwless exterior panels', '无螺钉外覆盖件', 'Panneaux extérieurs sans vis apparente'),
          t('E-track floor system', '地板 E 轨系统', 'Système e-track au plancher'),
          t('Cabinet package & workbench prep', '柜体套件与工作台预留', 'Forfait d’armoires et préparation d’établi'),
          t('Roof vent and insulated option', '车顶通风与保温选项', 'Évent de toit et option isolée'),
          t('Spare tire & mount included', '含备胎及支架', 'Roue de secours et support inclus'),
        ],
      },
      {
        id: 'premium',
        features: [
          t('Custom lengths, heights and layouts', '定制长度、高度与布局', 'Longueurs, hauteurs et agencements sur mesure'),
          t('Onboard generator / inverter systems', '车载发电机/逆变器系统', 'Génératrice / systèmes onduleur embarqués'),
          t('Contractor package: racks, bins, ladder', '工程套餐：货架、零件盒、爬梯', 'Forfait entrepreneur : galeries, bacs, échelle'),
          t('Finished interior with LED shop lighting', '精装内饰与 LED 工作灯', 'Intérieur aménagé avec éclairage d’atelier DEL'),
          t('Custom graphics & branding ready', '支持定制贴膜与品牌涂装', 'Prêt pour graphiques et image de marque'),
          t('Heavy-duty ramp with spring assist', '重型弹簧辅助坡道门', 'Rampe lourde avec assist. à ressort'),
        ],
      },
    ],
    upgradeIds: ['interior-finishes', 'doors-windows', 'exterior-walls', 'smart-controls', 'deck-addons', 'other-accessories'],
