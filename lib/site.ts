...
export const SITE = {
  ...
  url: 'https://nexus-assembly.vercel.app',
  email: 'info@nexus-assembly.vercel.app',
...
export const NAV: NavItem[] = [
  ...
  { label: t('Customization', '产品定制', 'Personnalisation'), href: '/#customization' },
  { label: t('Assembly', '组装中心', 'Assemblage'), href: '/#assembly' },
  { label: t('Quality & Compliance', '质量与合规', 'Qualité et conformité'), href: '/#quality' },
  {
...
export const FOOTER_COLS: { title: LocalizedText; links: NavChild[] }[] = [
  {
    ...
    links: [
      ...
      { href: '/#customization', label: t('Customization', '产品定制', 'Personnalisation'), desc: t('', '', '') },
    ],
  },
  {
    ...
    links: [
      ...
      { href: '/#quality', label: t('Quality & Compliance', '质量与合规', 'Qualité et conformité'), desc: t('', '', '') },
